        ...
        <tbody>
          {balances.map((b) => (
            <tr key={b.memberId} className="border-b border-gray-50 last:border-0">
              ...
              <td className="py-2 text-right text-gray-500">{b.paid.toLocaleString("vi-VN")} đ</td>
              <td className="py-2 text-right text-gray-900">{b.owed.toLocaleString("vi-VN")} đ</td>
            </tr>
          ))}
          {balances.length === 0 && (
            <tr>
